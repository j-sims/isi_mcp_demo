...
The server provides comprehensive cluster management through 215 MCP tools organized into 41 groups. All tools ship enabled by default. Tool access can be controlled in two ways:
